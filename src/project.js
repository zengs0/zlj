...
window.__require = function e(t, n, o) {
      ...
      p = function (e) {
        ...
        return o(t, e), n = t, t.prototype.onLoad = function () {
          ...
          this.canClick && (this.moreGameBtn.off(cc.Node.EventType.TOUCH_START, this.OnClickMoreGame, this), this.canClick = !1, this.moreGameBtn.runAction(cc.sequence(cc.scaleTo(.1, 1.1), cc.scaleTo(.1, 1))), this.scheduleOnce(function () {
            window.location.href = "http://m.wesanee.com/"
          }, .15))
  ...
  HttpManagerJs: [function (e, t, n) {
    ...
    var a = e("GameConfig"),
      i = (c(o = {
        URL: "http://www.wesanee.com/h5service.php/Interface/services",
        cacheList: null,
        isBusy: null,
        req: null,
        perform: null,
    ...
    var o = e("HttpManagerJs"),
      ...
      r = (e("GameUiTools"), {
        ...
        getHttpGameId: function () {
          ...
          this.moreGameUrl = "http://m.wesanee.com/"
        },
        gameOverShowText: function (e, t) {
          this.ajaxLoad("http://www.wesanee.com/admin.php/Gamescore/saveGamescore", "gameScore=" + e + "&gameId=" + this.gameHttpId + "&gameType=" + t, this.scoreResult)
        },
        gamePV_load: function () {
          this.ajaxLoad("http://www.wesanee.com/admin.php/Activityshow/gamelogo", "gameID=" + this.gameHttpId, this.ajaxOnLogoResult)
        },
